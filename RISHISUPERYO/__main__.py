...
from RISHISUPERYO import (ALLOW_EXCL, CERT_PATH, DONATION_LINK, LOGGER,
                ...
                reply_markup=InlineKeyboardMarkup(
                    [[
                     ...
                     [
                        InlineKeyboardButton(
                            text=" ⚡ ѕσυя¢є ¢σ∂є ",
                            url="https://GitHub.com/Rishisuperyo-Gamerz/Op-Rocky-Rishisuperyo-bot"),
                         InlineKeyboardButton(
                            text=" ❤️ Channel ",
                             url="https://t.me/OP_ROCKY_RISHISUPERYO_BOT_UPDATE")        
                      ],
                      [ 
                        InlineKeyboardButton(
                             text=" ✨ Support ",
                             url="https://t.me/op_rocky_rishisuperyo_bot_help"),
                        InlineKeyboardButton(
                             text=" 👨‍💻 Creator ",
